...
function DialogOverlay({
 ...
 className={cn(
 "fixed inset-0 isolate z-50 bg-background/80 duration-150 supports-backdrop-filter: data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
 className
 )}
 {...props}
 />
